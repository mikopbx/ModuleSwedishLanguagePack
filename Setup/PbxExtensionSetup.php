...
namespace Modules\ModuleSwedishLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Swedish Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Swedish UI translations from Messages/sv/ directory
 * - Swedish voice prompts from Sounds/sv-sv/ directory
 *
 ...
 *
 * @package Modules\ModuleSwedishLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleSwedishLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Swedish packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Swedish Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Swedish Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Swedish Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Swedish Language Pack uninstalled successfully',
            LOG_INFO
        );
